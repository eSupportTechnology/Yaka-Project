...
use App\Http\Controllers\frontend\MembershipPackagesController;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::match(['get', 'post'], '/membership/payment/init', [MembershipPackagesController::class, 'initPayment'])
...
Route::middleware([App\Http\Middleware\AdminAuth::class])->group(function () {
    ...
    Route::get('/membership-plans/create', [MembershipPlanController::class, 'membershipPlancreate'])->name('membership-plans.create');
