        ...
        <div class="col-lg-6 grid-margin stretch-card mx-auto">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" id="admin-form" method="post" action="<?php echo e('dashboard.users.update-user', $user -> id); ?>" >
                        <?php echo csrf_field(); ?>
