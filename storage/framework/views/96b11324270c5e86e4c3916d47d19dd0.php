  ...
  <div class="container">
    <div class="row">
      <div class="pt-5 pb-5 col-md-12">
        <h2 class="mt-5 mb-4 text-center"> <?php echo e(GoogleTranslate::trans('Ads Posting Allowances', app()->getLocale())); ?></h2>
        <p class="mb-4 text-center"> <?php echo e(GoogleTranslate::trans('Free ad posting is available in every category. Contact us to become a Yaka.lk subscriber and own your stall today.', app()->getLocale())); ?></p>
...
<?php echo $__env->make('web.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Yaka-Project\resources\views/web/ads-posting-allowances.blade.php ENDPATH**/ ?>