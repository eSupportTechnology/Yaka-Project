                        ...
                        <table class="table">
                            ...
                            <?php $__currentLoopData = $adsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ads): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($ads->main_location->name_en); ?></td>
                                    <td><?php echo e($ads->sub_location->name_en); ?></td>
                                    <td>
                                        <?php if($ads->status == 1): ?>
                                    ...
                                    <td>
                                        <div class="template-demo d-flex  flex-nowrap">
                                            <a href="<?php echo e(route('ads.details',[$ads->id])); ?>" class="btn btn-primary">
...
<?php echo $__env->make('adminPanel.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Yaka-Project\resources\views/adminPanel/adsManagement/index.blade.php ENDPATH**/ ?>