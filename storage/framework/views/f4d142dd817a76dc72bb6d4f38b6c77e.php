    ...
    <div class="col-lg-6 grid-margin stretch-card mx-auto">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" id="admin-form" method="post" action="<?php echo e(route('dashboard.users.delete-user', $user -> id)); ?>" >
                    <?php echo csrf_field(); ?>
                    ...
                    <a href="<?php echo e(route('dashboard.users')); ?>" class="btn btn-light">Cancel</a>
                </form>
