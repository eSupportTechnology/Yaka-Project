...
<aside class="navbar-aside shadow-sm" id="offcanvas_aside">
    ...
    <nav>
        <ul class="menu-aside">
            ...
            <li class="menu-item <?php echo e(request()->routeIs('dashboard.admins') ? 'active' : ''); ?>">
                <a class="menu-link" href="<?php echo e(route('dashboard.admins')); ?>">
                    <i class="icon material-icons md-person"></i>
                    <span class="text">Admin</span>
                </a>
            </li>

            <li class="menu-item <?php echo e(request()->routeIs('dashboard.users') ? 'active' : ''); ?>">
                <a class="menu-link" href="<?php echo e(route('dashboard.users')); ?>">
                    <i class="icon material-icons md-people"></i>
                    <span class="text">User</span>
                </a>
            </li>

            <li class="menu-item <?php echo e(request()->routeIs('dashboard.categories') ? 'active' : ''); ?>">
                <a class="menu-link" href="<?php echo e(route('dashboard.categories')); ?>">
            ...
            <li class="menu-item <?php echo e(request()->routeIs('dashboard.configuration.brands-and-models') ? 'active' : ''); ?>">
                <a class="menu-link" href="<?php echo e(route('dashboard.configuration.brands-and-models')); ?>">
                    <i class="icon material-icons md-business"></i>
                    <span class="text">Brands And Models</span>
                </a>
            </li>

            <li class="menu-item <?php echo e(request()->routeIs('dashboard.packages') ? 'active' : ''); ?>">
                <a class="menu-link" href="<?php echo e(route('dashboard.packages')); ?>">
                    <i class="icon material-icons md-markunread_mailbox"></i>
                    <span class="text">Package</span>
                </a>
            </li>

            <li class="menu-item <?php echo e(request()->routeIs('dashboard.adsTypes') ? 'active' : ''); ?>">
                <a class="menu-link" href="<?php echo e(route('dashboard.adsTypes')); ?>">
            ...
            <li class="menu-item <?php echo e(request()->routeIs('dashboard.banner') ? 'active' : ''); ?>">
                <a class="menu-link" href="<?php echo e(route('dashboard.banner')); ?>">
...
<?php /**PATH C:\xampp\htdocs\Yaka-Project\resources\views/newAdminDashboard/Sidebar.blade.php ENDPATH**/ ?>