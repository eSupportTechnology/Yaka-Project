    ...
    <div class="user-form-category">
        ...
        <div class="tab-pane active" id="login-tab">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <input type="text" class="form-control" name="phone_number"  value="<?php echo e(old('phone_number')); ?>" placeholder="Phone number">
                   ...
                   <div class="col-3">
                       <div class="form-group text-right">
                           <a href="<?php echo e(route('forgot')); ?>" class="form-forgot">Forgot password?</a>
                       </div>
                   </div>
                    <div class="col-12">
                        <div class="form-group">
            ...
            <div class="user-form-direction">
                <p>Don't have an account? click on the <span>( <a href="<?php echo e(route('register')); ?>">sign up</a> )</span> button above.</p>
            </div>
        </div>
    </div>
</section>
...
<?php /**PATH C:\xampp\htdocs\Yaka-Project\resources\views/web/user/login.blade.php ENDPATH**/ ?>