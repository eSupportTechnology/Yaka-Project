        ...
        <section class="banner-section">
            <div class="auto-container" >
                <div class="content-box">
                    <div class="text">
                        <h1 style="font-size:45px"><?php echo app('translator')->get('You can #Buy, #Sell, #Rent, #Booking anything from here.'); ?></h1>
                ...
                <div class="category-block-one wow fadeInDown animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                    <a href="<?php echo e(route('browse-ads', ['category' => $category->id])); ?>" style="text-decoration: none;">
                        <div class="inner-box">
                            ...
                            <div class="icon-box">
                                <img src="<?php echo e(asset('images/Category/' . $category->image ?? 'default.png')); ?>"
...
<?php echo $__env->make('newFrontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\eSupport\Yaka-Project\resources\views/newFrontend/index.blade.php ENDPATH**/ ?>