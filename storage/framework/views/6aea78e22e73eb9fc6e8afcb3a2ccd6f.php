                                ...
                                <div class="col-md-8">
                                    <div id="adsCarousel" class="carousel slide mb-2" data-bs-ride="carousel" data-bs-interval="2000">
                                        ...
                                        <div class="carousel-indicators">
                                            <?php $__currentLoopData = $topAds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $ad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($ad->ads_package == 3): ?> <!-- Filter ads with ads_package = 3 -->
                                                    ...
                                                    <div class="carousel-item <?php echo e($key === 0 ? 'active' : ''); ?>">
                                                        ...
                                                        <a href="<?php echo e(route('ads.details', ['ad_id' => $ad->id])); ?>" style="display: block; height: 100%; text-decoration: none;">
                                                            <div class="carousel-item-content">
                                                                ...
                                                                <!-- Top-left image -->
                                                                <img src="<?php echo e(asset('1.png')); ?>" class="top-left-image">
                                            ...
                                            <div class="inner-box" style="display: flex; flex-direction: column; height: 100%; justify-content: space-between;">
                                                <div class="image-box" style="flex-grow: 0;">
                                                    ...
                                                    <?php if($ad->ads_package == 4): ?>
                                                        <!-- URGENT tag for ads with package = 4 -->
                                                        <div class="feature" style="background-color:rgb(172, 3, 3)">
                                                            URGENT
                                                        </div>
                                                    <?php elseif($ad->ads_package == 5): ?>
                                                        <!-- Jump Up icon for ads with package = 5 -->
                                                        <div class="icon">
