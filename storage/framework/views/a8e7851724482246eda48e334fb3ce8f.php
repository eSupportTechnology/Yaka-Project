    ...
    <div class="col-lg-6 grid-margin stretch-card mx-auto">
        <div class="card">
            <div class="card-body">
                ...
                <a href="<?php echo e(route('dashboard.users.update',[$user->id])); ?>"  class="btn btn-primary me-2">Update This Details</a>
