...
<!-- Fav Icon -->
<link rel="icon" href="<?php echo e(asset('Logo-icon.png')); ?>" type="image/x-icon">
...
<body>
    ...
    <div class="boxed_wrapper">
        ...
        <?php echo $__env->make('newFrontend.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        
        <?php echo $__env->yieldContent('content'); ?>

        <?php echo $__env->make('newFrontend.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
           <!--Scroll to top-->
...
<?php /**PATH C:\Users\ASUS\Desktop\eSupport\Yaka-Project\resources\views/newFrontend/master.blade.php ENDPATH**/ ?>