...
<style>
    ...
    <div class="row">
      <div class="mt-5 col-md-12">
        ...
        <form action="<?php echo e(route('contact.submit')); ?>" method="post" style="background: #ffffff;padding: 22px;margin-bottom: 46px;">
          ...
          <button type="submit" class="mt-3 btn btn-primary"><?php echo e(GoogleTranslate::trans('Send', app()->getLocale())); ?></button>
        </form>
        <!-- End of Contact Form -->
  ...
  <div class="mt-5 google-container">
    <h2 class="text-center"><?php echo e(GoogleTranslate::trans('Our Location on the Map', app()->getLocale())); ?></h2>
...
<?php echo $__env->make('web.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Yaka-Project\resources\views/web/contact.blade.php ENDPATH**/ ?>