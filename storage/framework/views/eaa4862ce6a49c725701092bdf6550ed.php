...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('web/css/custom/index.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('web/css/custom/ad-details.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('web/css/custom/ad-post.css')); ?>">
...
<!--=====================================
            BANNER PART START
=======================================-->
<?php echo $__env->make('web.Blocks.dashboard-banner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<!--=====================================
            BANNER PART END
=======================================-->

<?php echo $__env->make('web.Blocks.dashboard-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\xampp\htdocs\Yaka-Project\resources\views/web/user/layout.blade.php ENDPATH**/ ?>