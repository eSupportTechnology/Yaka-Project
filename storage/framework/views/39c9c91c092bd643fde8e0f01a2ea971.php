                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="dash-menu-list">
                            <ul>
                                <li><a  class="active" href="<?php echo e(route('user.dashboard')); ?>"><?php echo app('translator')->get('messages.Dashboard'); ?></a></li>
        ...
        <div class="container mb-4">
            ...
            <div class="row mt-5 " >
                ...
                <div class="col-lg-8">
                    ...
                    <h1><?php echo app('translator')->get('messages.Welcome to Yaka.lk'); ?></h1>
                    <p style="text-align:justify">
                    <?php echo app('translator')->get('messages.para11'); ?></p>
                </div>
            </div>
...
<?php echo $__env->make('newFrontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\eSupport\Yaka-Project\resources\views/newFrontend/user/dashboard.blade.php ENDPATH**/ ?>