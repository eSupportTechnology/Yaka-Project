...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('admin/vendors/typicons/typicons.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('admin/vendors/simple-line-icons/css/simple-line-icons.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('admin/js/select.dataTables.min.css')); ?>">
...
<div class="container-scroller">
    ...
    <?php echo $__env->make('adminPanel.blocks.nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- partial -->
    <div class="container-fluid page-body-wrapper">

        <!-- partial:partials/_sidebar.html -->
       <?php echo $__env->make('adminPanel.blocks.sideBar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- partial -->
...
<script src="<?php echo e(asset('admin/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\Yaka-Project\resources\views/adminPanel/layout/layout.blade.php ENDPATH**/ ?>