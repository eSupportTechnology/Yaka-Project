...
<div class="row">
    ...
    <form class="adpost-form" method="post"   action="<?php echo e(route('user.dashboard.ad-post.post')); ?>" enctype="multipart/form-data">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <?php echo csrf_field(); ?>
                        <?php if(isset($subcategoryurl)): ?>
                                <?php
                                    $catUrl = \App\Models\Category::where('url',$subcategoryurl)->with('cat')->first();

                                ?>
                                <?php if($catUrl->cat[0]->url != "jobs"): ?>
                                    <?php echo $__env->make('web.components.AdsForms.'.$catUrl->cat[0]->url.'.'.$subcategoryurl, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php else: ?>
                                    <?php echo $__env->make('web.components.AdsForms.'.$catUrl->cat[0]->url.'.'.$catUrl->cat[0]->url, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php endif; ?>
                        <?php endif; ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="location" name="location" onchange="selecterror('district')" class="form-control custom-select">
                                            ...
                                            <?php $__currentLoopData = $districts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $district): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php if(old('location')== $district->id): ?> selected  <?php endif; ?> value="<?php echo e($district->id); ?>"><?php echo e($district->name_en); ?></option>
                        ...
                        <div class="adpost-card">
                            ...
                            <ul class="adpost-plan-list">
                                ...
                                <li style="display: block ;<?php if($plan->id==5): ?> display: none <?php endif; ?>">
                                    <div class="row">
                                        <div class="col-lg-5">
                                            <div style="margin-bottom: 20px;display: flex;align-items: center">
                                                <h4> <?php echo e($plan->name); ?> <?php echo e($plan->id); ?></h4>
                                            </div>
                                            <?php $__currentLoopData = $plan->packageTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $packageType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div style="display: flex;align-items: center;margin-left: 10px;margin-bottom: 15px;">
                                                    <div  class="adpost-plan-content">
                                                        <h6 style="margin: 0"><?php echo e($packageType->name); ?>   <span></span></h6>
                                                    </div>
                                                    <div class="adpost-plan-meta" style="display: flex;justify-content: space-around;width: 180px;">
                                                        <h5 style="margin-right: 10px">(LKR <?php echo e($packageType->price); ?>)</h5>
                                                        <input type="radio" name="plan_id" value="<?php echo e($packageType->id); ?>" id="">
                                                    </div>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
...
as add promoted to super add.  </p>
                        ...
                        <input type="hidden" name="subcatId" value="<?php echo e($subcatId); ?>">
...
<?php echo $__env->make('web.user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Yaka-Project\resources\views/web/user/post-ads.blade.php ENDPATH**/ ?>