<?php $__env->startSection('content'); ?>
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Update <?php if(isset($maincategory) && $category->mainId != 0 ): ?> Sub <?php endif; ?> Category</h4>
                    ...
                    <form class="forms-sample" id="admin-form" method="post" action="<?php echo e(route('dashboard.categories.update-category', $category->url)); ?>" enctype="multipart/form-data" >
                        <?php echo csrf_field(); ?>
                        ...
                        <?php if(!isset($maincategory)): ?> 
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="count" name="free_add_count" value="<?php echo e(old('free_add_count') ?? ($category->mainId != 0 ? 0 : $category->free_add_count)); ?>" placeholder="Free add count">
                            </div>
                        <?php endif; ?>
...
<?php echo $__env->make('newAdminDashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Yaka-Project\resources\views/newAdminDashboard/categoryManagement/update.blade.php ENDPATH**/ ?>