 ...
 <footer class="main-footer">
            <div class="footer-top" style="background-image: url(newFrontend/Clasifico/assets/images/background/footer-1.jpg);">
                                    ...
                                    <div class="post-inner">
                                        <div class="post">
                                            <figure class="post-thumb">
                                                <img src="newFrontend/Clasifico/assets/images/resource/footer-post-1.jpg" alt="">
                                        ...
                                        <div class="post">
                                            <figure class="post-thumb">
                                                <img src="newFrontend/Clasifico/assets/images/resource/footer-post-2.jpg" alt="">
                                                <a href="blog-details.html"><i class="fas fa-link"></i></a>
                                            </figure>
