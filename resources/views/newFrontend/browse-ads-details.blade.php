                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="shareDropdown">
                                            <li>
                                                ...
                                                href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('ads.details', ['adsId' => $ads->adsId]) }}" 
                                                target="_blank">
                                            ...
                                            <li>
                                                <a class="dropdown-item" 
                                                href="https://api.whatsapp.com/send?text={{ urlencode($ad->title) }}%0A%0A{{ urlencode($ad->description) }}%0A%0A🔗 {{ route('ads.details', ['adsId' => $ads->adsId]) }}" 
                                                target="_blank">
