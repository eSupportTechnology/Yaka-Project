                ...
                <div class="add-details-content">
                    <div class="content-one single-box">
                        <div class="text">
                            ...
                            <p class="fw-bold">
                                @lang('messages.Posted on'):
                                {{ \Carbon\Carbon::parse($ad->created_at)->translatedFormat('d M Y g:i a') }}
                        ...
                        <div class="bxslider">
                            <div class="slider-content">
                                <div class="product-image watermark">
                                    <figure class="image">
                                        <img id="mainImage" src="{{ asset('storage/' . $mainImage) }}" alt="Main Image"
                    ...
                    <div class="sidebar-search sidebar-widget">
                        <div class="widget-content">
                            <div class="d-flex justify-content-between align-items-center">
                                <!-- Share Dropdown -->
                                <div class="dropdown">
                                    <button class="btn btn-light dropdown-toggle" type="button" id="shareDropdown"
                                ...
                                <!-- Boost Ad Button -->
                                <a href="{{ route('ads.boost', ['adsId' => $ad->adsId]) }}"
                            ...
                            <div class="p-3 mt-3 user-details">
                                ...
                                <div class="mb-3 d-flex align-items-center">
                                    ...
                                    <span class="text-wrap">{{ $ad->user->first_name }}
                                        {{ $ad->user->last_name ?? 'N/A' }}</span>
                                </div>
                                <hr class="my-2">
        ...
        <div class="auto-container">
            ...
            <div class="four-item-carousel owl-carousel owl-theme owl-nav-none dots-style-one">
                @foreach ($relatedAds as $relatedAd)
                    <a href="{{ route('ads.details', ['adsId' => $relatedAd->adsId]) }}"
                        ...
                        <div class="feature-block-one"
                            ...
                            <div class="inner-box"
                                ...
                                <div class="lower-content"
                                    style="flex-grow: 1; flex-direction: column; justify-content: space-between;height: 260px;">
                                    <div class="mt-3 category"><i class="fas fa-tags"></i>
                                        <p>@lang('messages.' . $relatedAd->category->name ?? 'N/A')</p>
                                    </div>
                                    <h4
                                    ...
                                    <ul class="clearfix info">
                                        <li><i class="fas fa-clock"></i>{{ $relatedAd->created_at->diffForHumans() }}</li>
                                        <li>
