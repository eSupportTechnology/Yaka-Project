            ...
            <ul class="nav nav-tabs" id="adsTabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="active-ads-tab" data-bs-toggle="tab" href="#active-ads" role="tab"
                        aria-controls="active-ads" aria-selected="true">@lang('messages.Active Ads')</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pending-ads-tab" data-bs-toggle="tab" href="#pending-ads" role="tab"
                        aria-controls="pending-ads" aria-selected="false">@lang('messages.Pending Ads')</a>
                </li>
            </ul>
                            ...
                            <div class="mb-4 col-md-4">
                                <a href="{{ route('ads.details', ['adsId' => $ad->adsId]) }}">
                                    <div class="card ad-card">
                                        <img src="{{ asset('storage/' . $ad->mainImage) }}" class="card-img-top"
                                            alt="Ad Image">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text text-muted">
                                                ...
                                                @else
                                                    ...
                                                    @else
                                                        @lang('messages.Expires on')
                                                        {{ \Carbon\Carbon::parse($ad->package_expire_at)->translatedFormat('d M Y') }}
                                                    @endif
                                                @endif
                                            </p>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <!-- DELETE BUTTON (Left) -->
                                                <form action="{{ route('ads.delete', ['adsId' => $ad->adsId]) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                ...
                                                <div class="ml-2">
                                                    <!-- EDIT BUTTON (Right) -->
                                                    <a href="{{ route('ads.edit', ['adsId' => $ad->adsId, 'cat_id' => $ad->cat_id]) }}"
