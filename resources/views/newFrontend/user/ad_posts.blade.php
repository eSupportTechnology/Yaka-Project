                    ...
                    <div class="col-lg-12">
                        <div class="dash-menu-list">
                            <ul>
                                ...
                                <li><a class="active" href="{{ route('user.ad_posts.categories') }}">@lang('messages.ad post')</a>
                                </li>
                                @if (Auth::check() && Auth::user()->roles != 'staff')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="p-4 account-card alert fade show"
                        ...
                        <form id="adForm"
                            action="{{ route('user.ad_posts.store') }}?cat_id={{ $cat_id }}&sub_cat_id={{ $sub_cat_id }}&location={{ $location }}&sublocation={{ $sublocation }}"
                                            ...
                                            <div class="flex-wrap gap-3 d-flex">
                                                ...
                                                <div class="mb-3 col-lg-6">
                                                    <div class="form-group">
                                                        <label
                                                            class="form-label text-dark"><strong>@lang('messages.Brand')</strong></label>
                                                        <select id="brand" name="brand"
                                                            class="form-control custom-select">
                                                            <option value="">@lang('messages.Brand')</option>
                                                            @foreach ($brands as $brand)
                                                                <option value="{{ $brand->id }}"
                                                                    @if (request()->brand == $brand->id) selected @endif>
                                                                    {{ $brand->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="mb-3 col-lg-6">
                                                    <div class="form-group">
                                                        <label
                                                            class="form-label text-dark"><strong>@lang('messages.Model')</strong></label>
                                ...
                                <div class="mb-3 col-lg-12">
                                    <div class="section-box">
                                        <div class="alert alert-info mb-3">
                                            <i class="fas fa-info-circle"></i> <strong>Staff Note:</strong> You are creating
                                            a new user account. Please enter the customer's details below.
                                        </div>
                                        <div class="row">
                                            <div class="mb-3 col-lg-6">
                                                <div class="form-group">
                                                    <label class="form-label text-dark"><strong>@lang('messages.First Name') <i
                                            ...
                                            <div class="mb-3 col-lg-6">
                                                <div class="form-group">
                                                    <label class="form-label text-dark"><strong>@lang('messages.Last Name') <i
                                                                class="text-danger">*</i></strong></label>
                                            ...
                                            <div class="mb-3 col-lg-6">
                                                <div class="form-group">
                                                    <label
                                                        class="form-label text-dark"><strong>@lang('messages.Email')</strong></label>
                                            ...
                                            <div class="mb-3 col-lg-6">
                                                <div class="form-group">
                                                    <label class="form-label text-dark"><strong>@lang('Phone Number') <i
                                                                class="text-danger">*</i></strong></label>
        ...
        $(document).ready(function() {
            ...
            $('#main_image').change(function() {
                ...
                reader.onload = function(e) {
                    $('#main_image_preview').html('<img src="' + e.target.result +
                        '" alt="Main Image" style="max-width: 20%; height: auto; border: 1px solid #ddd; padding: 5px;">'
                    );
                }
