        ...
        <div class="col-lg-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" id="admin-form" method="post" action="{{route('dashboard.staffs.store')}}" >
                        @csrf
                        ...
                        <div class="form-group">
                            <select class="form-control" name="role" id="exampleFormControlSelect2" style="display: none;">
