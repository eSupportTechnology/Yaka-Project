...
<div class="content-header">
    <div>
        <h2 class="content-title card-title">Staff List</h2>
    </div>
    <div>
        <a href="{{route('dashboard.staffs.create')}}" class="btn btn-primary btn-sm rounded">Create Staff</a>
    </div>
</div>
                            ...
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <div class="template-demo d-flex flex-nowrap">
                                        <a href="{{route('dashboard.staffs.view',[$user->id])}}" class="btn btn-view btn-sm me-2">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{route('dashboard.staffs.update',[$user->id])}}" class="btn btn-warning btn-sm me-2">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="{{route('dashboard.staffs.delete',[$user->id])}}" class="btn btn-danger btn-sm me-2">
