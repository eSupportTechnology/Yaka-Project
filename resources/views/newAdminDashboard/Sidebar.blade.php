    ...
    <nav>
        <ul class="menu-aside">
            @if (Auth::check() && Auth::user()->roles == 'admin')
                ...
                <li class="menu-item {{ request()->routeIs('membership-plans.purchase') ? 'active' : '' }}">
                    <a class="menu-link" href="{{ route('membership-plans.purchase') }}">
                        <i class="icon material-icons md-account_balance_wallet"></i>
                        <span class="text">Purchased Membership</span>
                    </a>
            ...
            @if (Auth::check() && Auth::user()->roles == 'admin')
                ...
                <li
                    class="menu-item {{ request()->routeIs('dashboard.configuration.brands-and-models') ? 'active' : '' }}">
