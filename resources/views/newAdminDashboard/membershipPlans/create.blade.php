...
<div class="content-header">
    <h2 class="content-title">Create Membership Plan</h2>
</div>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('membership-plans.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" id="ads_per_month" name="ads_per_month" class="form-control" required min="0">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" id="valid_month" name="valid_month" class="form-control" required min="1">
                    </div>

                    <div class="mb-3">
                        <label for="promotion_voucher_cost" class="form-label">Voucher Cost</label>
                        <input type="number" step="0.01" id="promotion_voucher_cost" name="promotion_voucher_cost" class="form-control" min="0">
                    </div>
