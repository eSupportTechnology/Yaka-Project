                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="template-demo d-flex  flex-nowrap">
                                            ...
                                            <a href="{{route('dashboard.users.view',[$user->id])}}" class="btn btn-view btn-sm me-2">
                                            <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{route('dashboard.users.update',[$user->id])}}" class="btn btn-warning btn-sm me-2">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="{{route('dashboard.users.delete',[$user->id])}}" class="btn btn-danger btn-sm me-2">
