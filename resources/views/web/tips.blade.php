...
<div class="container">
  ...
  <div class="pt-5 pb-5 row bg-light">
    <div class="text-center col-md-12">
      <h3 class="mb-4">{{ GoogleTranslate::trans('Why Choose Us?', app()->getLocale()) }}</h3>
      <div class="row">
        <div class="col-md-4">
          <div class="feature-box">
            <img src="{{ asset('web/images/about/high_quality.png')}}" alt="High Quality" class="mb-3 img-fluid" style="width:100px;height:100px">
            <h5>{{ GoogleTranslate::trans('High-Quality Listings', app()->getLocale()) }}</h5>
            <p>{{ GoogleTranslate::trans('We ensure only high-quality ads appear on our platform.', app()->getLocale()) }}</p>
          </div>
        </div>
        <div class="col-md-4">
          <div class="feature-box">
            <img src="{{ asset('web/images/about/customer_support.png')}}" alt="Customer Support" class="mb-3 img-fluid"style="width:100px;height:100px">
            <h5>{{ GoogleTranslate::trans('24/7 Support', app()->getLocale()) }}</h5>
            <p>{{ GoogleTranslate::trans('Our team is always here to help you with your needs.', app()->getLocale()) }}</p>
          </div>
        </div>
        <div class="col-md-4">
          <div class="feature-box">
            <img src="{{ asset('web/images/about/secure.png')}}" alt="Secure" class="mb-3 img-fluid"style="width:100px;height:100px">
            <h5>{{ GoogleTranslate::trans('Secure Transactions', app()->getLocale()) }}</h5>
            <p>{{ GoogleTranslate::trans('We prioritize your security during every interaction.', app()->getLocale()) }}</p>
          </div>
        </div>
      </div>
    </div>
 ...
 <!-- Call-to-Action Section -->
  <div class="pt-5 pb-5 text-center text-white row "style="background-color: #8B0000;">
    <div class="col-md-12">
      <h3 class="mb-4">{{ GoogleTranslate::trans('Ready to Post Your Ad?', app()->getLocale()) }}</h3>
      <p>{{ GoogleTranslate::trans('Join thousands of satisfied customers today. It’s quick, easy, and free!', app()->getLocale()) }}</p>
      <a href="{{ url('/post-ad') }}" class="btn btn-light">{{ GoogleTranslate::trans('Post Your Ad Now', app()->getLocale()) }}</a>
    </div>
  </div>
</div>
