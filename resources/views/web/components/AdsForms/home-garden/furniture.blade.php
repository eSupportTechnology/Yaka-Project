<div class="adpost-card">
    <div class="adpost-title">
        <h3>{{ GoogleTranslate::trans('Home & Garden - Furniture', app()->getLocale())}}</h3>
    </div>
   <br>
   ...
   <div class="row mt-4">
    ...
    <div class="col-lg-12">
            <div class="form-group">
                <label class="form-label">{{ GoogleTranslate::trans('Funiture Type', app()->getLocale())}}</label>
                <select name="type"onchange="selecterror('type')"class="form-control custom-select">
                    <option selected value="0">Funiture Type</option>
