<div class="adpost-card">
    <div class="adpost-title">
        <h3>{{ GoogleTranslate::trans('Electronics - TV & Video Accessories', app()->getLocale())}}</h3>
    </div>
    <br>
    <br>
   ...
   <br><br>
    ...
    <div class="col-lg-12">
            <div class="form-group">
                <label class="form-label">{{ GoogleTranslate::trans('Device Type', app()->getLocale())}}</label>
