<div class="adpost-card">
    <div class="adpost-title">
        <h3>{{ GoogleTranslate::trans('Motor vehicles - Vans', app()->getLocale())}}</h3>
    </div>
    <div class="row mt-4">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group">
                ...
                <input value="{{old('engine_capacity')}}"onchange="selecterror('engine_capacity')"type="number"name="engine_capacity" class="form-control" placeholder="What is Engine capacity (cc)  of car">
