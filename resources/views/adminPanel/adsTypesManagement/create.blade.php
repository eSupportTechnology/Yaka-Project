...
@section('content')
    <div class="row">
        <div class="col-lg-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Create New @if(isset($maincategory)) Sub @endif Ads Types</h4>
                    ...
                    <form class="forms-sample" id="admin-form" method="post" action="{{route('dashboard.adsTypes.store')}}" enctype="multipart/form-data" >
