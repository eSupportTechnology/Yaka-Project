        ...
        <div class="col-lg-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" id="admin-form" method="post" action="{{route('dashboard.subpackage.store')}}" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" required  class="form-control" id="exampleInputUsername1" name="duration" value="{{ old('duration')  }}" placeholder="Duration">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputUsername1">Price(Rs)<span style="color: red">*</span></label>
                            <input type="number" required  class="form-control" id="exampleInputUsername1" name="price" value="{{ old('price')  }}" placeholder="Price(Rs)">
                        </div>
